...
class OrderInfo(BaseModel):
    ...
    passport = models.ForeignKey('users.Passport',verbose_name='下单用户')
    ...
    trade_id = models.CharField(max_length=100,unique=True,null=True,blank=True,verbose_name='支付编号')#null设置时数据可为空,blank是检验数据可为空
